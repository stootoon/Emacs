...
(setq openweathermap-apikey "f9ceccbdf8b3dc7da0b32b64ae7758b9")
...
OpenWeatherMap API data."
  (format "http://api.openweathermap.org/data/2.5/weather?q=%s&units=%s&appid=%s"
           weatherline-location weatherline-units openweathermap-apikey))
